	...
	return (
		<ProtectedScreen>
			<TouchableWithoutFeedback onPress={Keyboard.dismiss}>
				<KeyboardAvoidingView className="flex-grow" behavior={Platform.OS === "ios" ? "padding" : "height"}>
					<SafeAreaView className="flex-grow flex flex-col justify-center items-center bg-primary">
						<View className="w-full px-4">
							...
							<View>
								<View className="mb-6">
									<View className="mb-6">
										<FormControl label="Email" type="email" variant="outline" value={email} onChange={setEmail} />
									</View>
								...
								<View>
									<Touchable onPress={handleSubmit} isText>
										Login
									</Touchable>
