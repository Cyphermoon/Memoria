...
export async function uploadFolderItem(
	userId: string,
	folderId: string,
	item: AddFolderItemProps,
	type: CollectionOptionTypes
) {
...
export async function editFirestoreFolderItem(
	userId: string,
	folderId: string,
	itemId: string,
	type: CollectionOptionTypes,
	newData: EditFolderItemProps
) {
	// Declare a variable to hold the reference to the Firestore document.
	let folderItemRef
